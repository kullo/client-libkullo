...
/*
* This file was automatically generated Mon Jun 20 14:53:04 2016 UTC by
* daniel@twentyone running '/tmp/update-botan/1.11.30/Botan-1.11.30/configure.py --via-amalgamation --no-autoload --disable-shared --with-zlib --enable-modules=aes,sha1,sha2_32,sha2_64,auto_rng,codec_filt,eme_oaep,emsa_pssr,gcm,hres_timer,rsa,srp6,system_rng,dev_random,proc_walk --os=linux --cpu=x86_32 --cc=gcc'
*
* Target
*  - Compiler: g++  -pthread -fstack-protector -std=c++11 -D_REENTRANT -O3 -momit-leaf-frame-pointer
*  - Arch: x86_32/x86_32
*  - OS: linux
*/
