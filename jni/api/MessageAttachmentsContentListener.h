...
public:
    ...
    static ::djinni::LocalRef<JniType> fromCpp(JNIEnv* jniEnv, const CppType& c) { return {jniEnv, ::djinni::JniClass<MessageAttachmentsContentListener>::get()._toJava(jniEnv, c)}; }
...
private:
    ...
    class JavaProxy final : ::djinni::JavaProxyCacheEntry, public ::Kullo::Api::MessageAttachmentsContentListener
    {
    public:
        JavaProxy(JniType j);
        ~JavaProxy();
