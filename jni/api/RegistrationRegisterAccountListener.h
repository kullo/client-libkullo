...
public:
    ...
    static ::djinni::LocalRef<JniType> fromCpp(JNIEnv* jniEnv, const CppType& c) { return {jniEnv, ::djinni::JniClass<RegistrationRegisterAccountListener>::get()._toJava(jniEnv, c)}; }
...
private:
    ...
    class JavaProxy final : ::djinni::JavaProxyCacheEntry, public ::Kullo::Api::RegistrationRegisterAccountListener
    {
    public:
        JavaProxy(JniType j);
        ~JavaProxy();
