...
public:
    ...
    static CppType toCpp(JNIEnv* jniEnv, JniType j) {
        DJINNI_ASSERT_MSG(j, jniEnv, "DraftAttachments::fromCpp requires a non-null Java object");
        return kulloForcedNn(::djinni::JniClass<DraftAttachments>::get()._fromJava(jniEnv, j));
    };
